...
public class NavitiaEnrichmentTest {
    ...
    private final String NAVITIA_REQ = "/api/v1/navitia/getJourneys?apiFormat=OSM&apiUrl=https://overpass.kumi.systems/api/interpreter?data=[out:json];node[highway=bus_stop](48.8345631,2.2433581,48.8775033,2.4400646);out%20meta;&enrichAttributes=wheelchair, shelter, tactile_paving, bench, bin, lit&fromCoordinates=48.8345631,2.2433581&toCoordinates=48.8775033,2.4400646&targetToken=55af740c-e0e9-4f2b-9387-3bb81a8c7bd4";
