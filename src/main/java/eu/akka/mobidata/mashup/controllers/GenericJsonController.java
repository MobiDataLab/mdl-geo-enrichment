...
public class GenericJsonController extends BaseController {
    ...
    String enrichJsonApi(@ApiParam(value = "Attributes to be enriched on the target api, separated with commas", required = true, example = "wheelchair, shelter, tactile_paving, bench, bin, lit") String enrichmentAttributes,
                         ...
                         @ApiParam(value = "Url of the target API to be enriched", required = true, example = "https://api.navitia.io/v1/journeys?from=4.3398019;50.8439547&to=4.3056933;50.8396064&allowed_id[]=physical_mode:Bus") String targetApiUrl,
                         @ApiParam(value = "Url of the source API to be used for enrichment", required = true, example = "https://overpass.kumi.systems/api/interpreter?data=[out:json];node[highway=bus_stop](50.8396064,4.3056933,50.8439547,4.3398019);out%20meta;") String sourceApiUrl,
